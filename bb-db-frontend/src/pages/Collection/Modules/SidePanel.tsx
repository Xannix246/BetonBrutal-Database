...
const SidePanel = ({ isPrivate, isMain, preview, setIsPrivate, setIsMain, onPublish, id }: SidePanel) => {
  ...
  return (
    <Container className="flex flex-col text-white place-items-center p-4 bg-black/60 w-[300px] h-full gap-16">
      <div className="text-5xl font-bold uppercase">Settings</div>
      ...
      <div className="flex flex-col justify-between h-full">
        ...
        {preview && <div className="flex flex-col place-items-center gap-4">
          <img
            ...
            alt="preview"
          />
          <h4 className="text-3xl uppercase font-bold">Preview image</h4>
        </div>}
        <div>
          <h5 className="text-gray-400 tracking-wide">* Private collections won't be visible in search, but still be avaiable with direct link</h5>
        </div>
