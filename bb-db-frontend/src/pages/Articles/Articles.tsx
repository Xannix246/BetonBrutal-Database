      ...
      <div className="flex flex-col min-h-screen justify-between pt-32">
        {loaded ? (
          <div className="flex flex-col">
            <div className="flex flex-col mb-16 w-full uppercase">
              <Container className="flex justify-center gap-10 text-4xl tracking-wide place-items-center text-white">
                {t(key.title)}
              </Container>
              {["writer", "admin"].includes(user?.role as string) && (
                <Container className="flex justify-center bg-green/40 gap-10 text-4xl tracking-wide place-items-center text-white">
                  <h2>{t(key.allowWrite)}</h2>
                  <Link
                    href="/articles/new"
                    className="hover:text-pink transition duration-300"
                  >
                    {t(key.editorLink)}
                  </Link>
                </Container>
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full px-4">
              <div className="md:sticky md:h-[calc(100vh-80px)] top-18 scrollbar-hide">
                <Container className="flex flex-col text-white place-items-center p-4 w-full md:w-[250px] h-full uppercase">
                  <div
                  ...
                  >
                    ...
                    <h2 className="text-xl font-bold">{t("articles.filters")}</h2>
                  </div>
                  <div
                    className={clsx(
                  ...
                  >
                    ...
                    <div className="w-full flex flex-col gap-2">
                      ...
                      <div className="flex gap-4">
                        <Checkbox
                          enabled={strictTagSearch}
                          setEnabled={setStrictTagSearch}
                        />
                        <h4 className="text-2xl font-bold text-center">
                          {t(key.includeAllTags)}
                        </h4>
                      </div>
                    </div>
                  </div>
              ...
              <div className="min-h-screen w-full">
                <div className="w-full flex flex-col gap-8 place-items-center">
                  <div className="flex w-full xl:max-w-5xl">
                    ...
                    />
                    <Button
                      className="text-xl py-2 h-full uppercase"
